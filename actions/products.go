...
func (v ProductsResource) New(c buffalo.Context) error {
	...
	categoriesForSelect := make(map[string]uuid.UUID)
	for _, category := range categories {
		categoriesForSelect[category.Name] = category.ID
	}
	c.Set("product", &models.Product{})
	// Pass categories to the template
	c.Set("categories_for_select", categoriesForSelect)
...
func (v ProductsResource) Create(c buffalo.Context) error {
	...
	return responder.Wants("html", func(c buffalo.Context) error {
		...
		return c.Redirect(http.StatusSeeOther, "/admin/products/%v", product.ID)
	}).Wants("json", func(c buffalo.Context) error {
